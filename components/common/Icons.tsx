...
export const PendingIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
     <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={className}>
...
export const ThumbsUpIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
        <path d="M1 8.25a1.25 1.25 0 112.5 0v7.5a1.25 1.25 0 11-2.5 0v-7.5zM11 3V1.7c0-.268.14-.516.379-.645a.75.75 0 01.87.126l1.32.99a1.5 1.5 0 01.682 1.24V7a.75.75 0 00.75.75h2.25a.75.75 0 00.75-.75v-2.5a.75.75 0 00-.75-.75h-2.25a.75.75 0 00-.75.75V5.5h-.75a.75.75 0 00-.75.75v3.25a.75.75 0 00.75.75h.75a2.25 2.25 0 012.25 2.25v.03a.75.75 0 00.803.72 15.62 15.62 0 005.197-2.122 1.5 1.5 0 00.548-2.003l-1.334-3.334a1.5 1.5 0 00-1.42-1.014h-4.32Z" />
    </svg>
);

export const ThumbsDownIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
        <path d="M19 11.75a1.25 1.25 0 10-2.5 0v-7.5a1.25 1.25 0 10-2.5 0v7.5zM9 17v1.3c0 .268-.14.516-.379-.645a.75.75 0 00-.87-.126l-1.32-.99a1.5 1.5 0 00-.682-1.24V13a.75.75 0 01-.75-.75H3.75a.75.75 0 01-.75.75v2.5a.75.75 0 01.75.75h2.25a.75.75 0 01.75-.75V14.5h.75a.75.75 0 01.75-.75v-3.25a.75.75 0 01-.75-.75h-.75A2.25 2.25 0 006.75 7.5v-.03a.75.75 0 01-.803-.72A15.62 15.62 0 01.75 4.628a1.5 1.5 0 01-.548 2.003l1.334 3.334a1.5 1.5 0 011.42 1.014h4.32Z" />
    </svg>
);

export const CopyIcon: React.FC<{ className?: string }> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 002.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 00-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 00.75-.75v-.664m2.25 0A48.667 48.667 0 0010.5 4.5c-1.257 0-2.512.144-3.75.424M6.75 18h.75a.75.75 0 00.75-.75V13.5a.75.75 0 00-.75-.75h-.75a.75.75 0 00-.75.75v3.75c0 .414.336.75.75.75zM6.75 12h.75a.75.75 0 00.75-.75V9a.75.75 0 00-.75-.75h-.75a.75.75 0 00-.75.75v2.25c0 .414.336.75.75.75z" />
    </svg>
);

export const VerifiedIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5 inline-block text-cyan-400 ml-1" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className={className}>
...
export const SearchVectorIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
...
export const GlobeIcon: React.FC<{ className?: string }> = ({ className = "w-5 h-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M12 21a9.004 9.004 0 0 0 8.716-6.747M12 21a9.004 9.004 0 0 1-8.716-6.747M12 21c1.356 0 2.673-.174 3.946-.512M12 21c-1.356 0-2.673-.174-3.946-.512M12 3c1.356 0 2.673.174 3.946.512M12 3c-1.356 0-2.673-.174-3.946-.512M12 3a9.004 9.004 0 0 0-8.716 6.747M12 3a9.004 9.004 0 0 1 8.716 6.747m-17.432 0h17.432M5.12 3.946c.328-.158.668-.292 1.026-.406M17.854 3.54c.358.114.7.248 1.026.406M2.323 14.252c-.052-.234-.1-.474-.142-.718M21.819 13.534c-.042.244-.09.484-.142.718" />
    </svg>
);